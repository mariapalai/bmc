...
from app.views import CanvasList, CanvasDetailView, CanvasCreate, CanvasUpdate, CanvasDelete, company
...
urlpatterns = [
    ...
    url(r'canvas/(?P<pk>[0-9]+)/update$', CanvasUpdate.as_view(), name='canvas-update'),
